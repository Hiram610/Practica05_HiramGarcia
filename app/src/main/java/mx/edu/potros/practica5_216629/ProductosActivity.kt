...
class ProductosActivity : AppCompatActivity() {
    ...
    fun agregarproductos(option: String?){
        ...
        var titleImage: ImageView = findViewById(R.id.imageView)

        when(option){
            "Antojitos"->{
                titleImage.setImageResource(R.drawable.antojitos)
            ...
            "Especialidades"->{
                titleImage.setImageResource(R.drawable.especialidades)
                ...
                menu.add(Product("Botana de Camarones al la Diabla", R.drawable.botanacamarones, "", 19.99))
                menu.add(Product("Torre de Camarón Negro", R.drawable.botanacamarones, "", 16.99))
                menu.add(Product("Botana de pulpo a la Diabla", R.drawable.botanacamarones, "Servido totopos, cebolla frita, arroz, lechuga y pico de gallo - Served with chips, grill onions, rice, lettuce and pico de gallo.", 24.99))
            ...
            "Combinaciones"->{
                titleImage.setImageResource(R.drawable.combinations)
            ...
            "Tortas" ->{
                titleImage.setImageResource(R.drawable.tortas)
            ...
            "Sopas"->{
                titleImage.setImageResource(R.drawable.sopas)
            ...
            "Bebidas"->{
                titleImage.setImageResource(R.drawable.drinks)
                menu.add(Product("Soft Drinks 20oz - Soda 20oz", R.drawable.sodas, "", 2.99))
